...
class net_nouri2_cnn(object):
    """
    Net 2 used in Daniel Nouris nolearn tutorial http://danielnouri.org/notes/2014/12/17/using-convolutional-neural-nets-to-detect-facial-keypoints-tutorial/#second-model-convolutions
    Input       1x96x96
    ...
    def __str__(self):
        return "CNN_I-C3x3-P2x2-C2x2-P2x2-C2x2-P2x2-D500-D500-O"
